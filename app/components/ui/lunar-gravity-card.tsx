...
export default function LunarGravityCard({ 
  ...
  return (
    <div className={`w-full h-full min-h-[400px] bg-transparent flex flex-col relative overflow-hidden ${className || ""}`}>
      <div className="relative w-full h-full pointer-events-auto z-0 flex items-center justify-center">
        <div className="absolute inset-0 w-full h-full">
          <Canvas shadows={{ type: THREE.PCFShadowMap }} camera={{ position: [0, 3, 7.5], fov: 45 }} dpr={[1, 2]}>
