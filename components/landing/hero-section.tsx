...
const words = ["ship", "build", "innovate", "deploy"];
      ...
      <div className="relative z-10 w-full max-w-[1400px] mx-auto px-6 lg:px-12 py-32 lg:py-40">
        ...
        >
          <span className="inline-flex items-center gap-3 text-sm font-mono text-white/60">
            ...
            Web3 Full-Stack & Autonomous AI Engineer
          </span>
        </div>
        ...
        <div className="mb-12">
          ...
          >
            <span className="block">Building products that</span>
        ...
        {/* Description */}
        <p className={`text-lg text-white/70 mb-8 max-w-xl transition-all duration-700 delay-200 ${
          isVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"
        }`}>
          I create autonomous AI agents and Web3 full-stack applications that push technical boundaries. Shipped 4+ products, built 150+ presets, and won grants from top organizations.
        </p>
      ...
      >
        <div className="max-w-[1400px] mx-auto flex items-start gap-10 lg:gap-20">
          {[
            ...
            { value: "150+", label: "Presets created" },
            { value: "$2,075", label: "Grants awarded" },
          ].map((stat) => (
